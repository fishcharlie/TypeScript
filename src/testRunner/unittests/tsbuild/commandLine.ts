    ...
    describe("unittests:: tsbuild:: commandLine::", () => {
        ...
        describe("emitDeclarationOnly::", () => {
            ...
            verifyTscWithEdits({
                ...
                fs: () => fs({ composite: true, emitDeclarationOnly: true }),
                commandLineArgs: ["--b", "/src/project2/src", "--verbose"],
                edits: [
                    noChangeRun,
                    {
            ...
            verifyTscWithEdits({
                scenario: "commandLine",
                subScenario: "emitDeclarationOnly on commandline with declaration and incremental",
                fs: () => fs({ incremental: true, declaration: true }),
                commandLineArgs: ["--b", "/src/project2/src", "--verbose", "--emitDeclarationOnly"],
                edits: [
                    noChangeRun,
                    {
            ...
            verifyTscWithEdits({
                scenario: "commandLine",
                subScenario: "emitDeclarationOnly false on commandline with declaration and incremental",
                fs: () => fs({ incremental: true, declaration: true, emitDeclarationOnly: true }),
                commandLineArgs: ["--b", "/src/project2/src", "--verbose"],
                edits: [
                    noChangeRun,
                    {
